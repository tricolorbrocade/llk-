...
public class victory extends javax.swing.JPanel 
    ...
    public victory(JFrame n2) { Maingameshow.level=1;
        initComponents();
    ...
    private void initComponents()  {
    	...
    	ImageIcon image = new ImageIcon("background/chenggong.png");
  	 ...
  	 play.addActionListener(new java.awt.event.ActionListener() {
	        public void actionPerformed(java.awt.event.ActionEvent evt) {
	            ...
	            NewJPanel p3=new NewJPanel(n2);//新建面板victory2，并将窗口n2传入
